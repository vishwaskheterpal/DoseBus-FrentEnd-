            ...
            <Container fluid>
                ...
                <Navbar.Collapse id="navbarScroll">
                    <Nav
                        ...
                        <Nav.Link as={Link} to="/ayurveda">Ayurveda</Nav.Link>
                        <Nav.Link as={Link} to="/medicines">Medicines</Nav.Link>
                        <Nav.Link as={Link} to="/covidEssentials">Covid Essentials</Nav.Link>
                        <Nav.Link as={Link} to="/bodyCare">Body-Care</Nav.Link>
