  ...
  return (
    ...
    <Carousel>
        <Carousel.Item className = "citem col-12" style = {{backgroundImage: `url(${img3})`}}>
            ...
            <div className="first-carousel container">       
                ...
                <div className="col-sm-5 content">
                    <h1 className="carousel-heading-one">One step to flawless beauty</h1>
                    <Link to ="/bodyCare" className="btn btn-lg btn-warning carousel-button btn-hover"> Order Now</Link>
                </div>
            </div>
        ...
        <Carousel.Item className = "citem col-12" style = {{backgroundImage: `url(${img4})`}}>
            ...
            <div className="first-carousel container">
                <div className="col-sm-5 content">
                    <h1 className="carousel-heading-two">Best and genuine corona virus protection products available here</h1>
                    <Link to="/covid19" className="btn btn-lg btn-warning carousel-button btn-hover">Order Now</Link>
                </div>
